...
function animatePath(line: google.maps.Polyline) {
    let count = 0;
...
export class paths {
    ...
    REVDA(){
        ...
        path4.getPath().push(wps_revda[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<revda.length ; i++){
            path4.getPath().push(revda[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        for(let i = 0 ;i<=wps_revda.length;i++)wps_revda[i].setMap(map);
    ...
    DENUB(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_denub[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<denub.length ; i++){
            path4.getPath().push(denub[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_denub.length;i++)wps_denub[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy18.length ; i++ )wps_rwy18[i].setMap(map);
    ...
    NURPO(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_nurpo[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<nurpo.length ; i++){
            path4.getPath().push(nurpo[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_nurpo.length;i++)wps_nurpo[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy18.length ; i++ )wps_rwy18[i].setMap(map);
    }
    ...
    DIRAL(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_diral[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<diral.length ; i++){
            path4.getPath().push(diral[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_diral.length;i++)wps_diral[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy18.length ; i++ )wps_rwy18[i].setMap(map);
    }
    ...
    RIVOS(){
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_rivos.length;i++)wps_rivos[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy18.length ; i++ )wps_rwy18[i].setMap(map);
    }
    ...
    PILAT(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_pilat[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<pilat.length ; i++){
            path4.getPath().push(pilat[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_pilat.length;i++)wps_pilat[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy18.length ; i++ )wps_rwy18[i].setMap(map);
    }
    ...
    CETUL(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_cetul[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<cetul.length ; i++){
            path4.getPath().push(cetul[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_cetul.length;i++)wps_cetul[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy18.length ; i++ )wps_rwy18[i].setMap(map);
    }
    REVDA36(){
        if(path4!=undefined)path4.setMap(null);
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_revda36[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<revda36.length ; i++){
            path4.getPath().push(revda36[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        // console.log(wps1[0].setVisible(true));
        //create current waypoints
        for(let i = 0 ;i<=wps_revda36.length;i++)wps_revda36[i].setMap(map);
    ...
    DENUB36(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_denub36[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<denub36.length ; i++){
            path4.getPath().push(denub36[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_denub36.length;i++)wps_denub36[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy36.length ; i++ )wps_rwy36[i].setMap(map);
        //wps.DENUB()[0].setVisible(true);
        //wps.RWY36()[0].setVisible(true);
    }
    ...
    NURPO36(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_nurpo36[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<nurpo36.length ; i++){
            path4.getPath().push(nurpo36[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_nurpo36.length;i++)wps_nurpo36[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy36.length ; i++ )wps_rwy36[i].setMap(map);
    }
    ...
    DIRAL36(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_diral36[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<diral36.length ; i++){
            path4.getPath().push(diral36[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_diral36.length;i++)wps_diral36[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy36.length ; i++ )wps_rwy36[i].setMap(map);
    }
    ...
    RIVOS36(){
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_rivos36.length;i++)wps_rivos36[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy36.length ; i++ )wps_rwy36[i].setMap(map);
    }
    ...
    PILAT36(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_pilat36[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<pilat36.length ; i++){
            path4.getPath().push(pilat36[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_pilat36.length;i++)wps_pilat36[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy36.length ; i++ )wps_rwy36[i].setMap(map);
    }
    ...
    CETUL36(){
        ...
        //create paths
        path4 = addPath([],"#4D4948",map);
        path4.getPath().push(wps_cetul36[0].getPosition() as google.maps.LatLng);
        for (let i = 0 ; i<cetul36.length ; i++){
            path4.getPath().push(cetul36[i] as google.maps.LatLng);
        }
        path4.setOptions({
            icons:[{
                icon:lineSymbol,
        ...
        animatePath(path4);
        //create current waypoints
        for(let i = 0 ;i<=wps_cetul36.length;i++)wps_cetul36[i].setMap(map);
        for(let i = 0 ; i <= wps_rwy36.length ; i++ )wps_rwy36[i].setMap(map);
    }
}

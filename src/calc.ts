import {pointsLoc,waypoints,vorNdb} from "./points.js";
...
export function toBrng(ang:number){
    return toDegrees(ang+360)%360;
}

var EarthRadiusMeters = 6378137.0;
export function gcd(wp1:google.maps.LatLng,wp2:google.maps.LatLng){
...
export function brg(wp1:google.maps.LatLng,wp2:google.maps.LatLng){
...
export function destPt(wp1:google.maps.LatLng,bearing:any, dist:any){
    ...
    let lng2 = lng1 + Math.atan2(Math.sin(brng)*Math.sin(dist/R)*Math.cos(lat1),

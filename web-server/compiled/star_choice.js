...
import { entry, entryMarker } from "./points.js";
...
export function choiceWind(name, wind) {
    if (wind >= 0 && wind <= 360) {
        if (wind > 90 && wind < 270) {
...
export function viewActive(wind) {
    if (wind >= 0 && wind <= 360) {
        if (wind > 90 && wind < 270) {
            let textContent = 'Usable RWY is 18';
...
//# sourceMappingURL=star_choice.js.map
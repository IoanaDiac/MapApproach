...
export class waypoints {
    ...
    REVDA() {
        var marker0 = addMarker(new google.maps.LatLng(toDecimal(43, 44, 0, "N"), toDecimal(29, 6, 36, "E")), "REVDA", map);
        var marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 3, 34, "N"), toDecimal(28, 45, 9, "E")), "BIRLU", map);
        var marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 4, 12, "N"), toDecimal(28, 26, 55, "E")), "PEVEX", map);
        var marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 27, 40, "N"), toDecimal(28, 30, 8, "E")), "FAF", map);
        var marker4 = addMarker(new google.maps.LatLng(toDecimal(44, 24, 12, "N"), toDecimal(28, 29, 39, "E")), "SDF", map);
        return [marker0, marker1, marker2, marker3, marker4];
    }
    DENUB() {
        var marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 3, 59, "N"), toDecimal(29, 26, 36, "E")), "DENUB", map);
        var marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 11, 46, "N"), toDecimal(28, 52, 36, "E")), "LERVU", map);
        var marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 4, 12, "N"), toDecimal(28, 26, 55, "E")), "PEVEX", map);
        var marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 27, 40, "N"), toDecimal(28, 30, 8, "E")), "FAF", map);
        var marker4 = addMarker(new google.maps.LatLng(toDecimal(44, 24, 12, "N"), toDecimal(28, 29, 39, "E")), "SDF", map);
        return [marker0, marker1, marker2, marker3, marker4];
    ...
    NURPO() {
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 28, 7, "N"), toDecimal(29, 18, 56, "E")), "NURPO", map);
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 22, 25, "N"), toDecimal(28, 52, 40, "E")), "VADNU", map);
        let marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 33, 3, "N"), toDecimal(28, 30, 52, "E")), "BAKOB", map);
        var marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 27, 40, "N"), toDecimal(28, 30, 8, "E")), "FAF", map);
        var marker4 = addMarker(new google.maps.LatLng(toDecimal(44, 24, 12, "N"), toDecimal(28, 29, 39, "E")), "SDF", map);
        return [marker0, marker1, marker2, marker3, marker4];
    }
    DIRAL() {
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 30, 39, "N"), toDecimal(27, 33, 15, "E")), "DIRAL", map);
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 22, 59, "N"), toDecimal(28, 4, 59, "E")), "NAMUV", map);
        let marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 26, 45, "N"), toDecimal(28, 7, 29, "E")), "EBEKU", map);
        let marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 33, 13, "N"), toDecimal(28, 17, 23, "E")), "MIVNU", map);
        let marker4 = addMarker(new google.maps.LatLng(toDecimal(44, 33, 3, "N"), toDecimal(28, 30, 52, "E")), "BAKOB", map);
        var marker5 = addMarker(new google.maps.LatLng(toDecimal(44, 27, 40, "N"), toDecimal(28, 30, 8, "E")), "FAF", map);
        var marker6 = addMarker(new google.maps.LatLng(toDecimal(44, 24, 12, "N"), toDecimal(28, 29, 39, "E")), "SDF", map);
        return [marker0, marker1, marker2, marker3, marker4, marker5, marker6];
    }
    RIVOS() {
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 39, 21, "N"), toDecimal(27, 39, 17, "E")), "RIVOS", map);
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 26, 45, "N"), toDecimal(28, 7, 29, "E")), "EBEKU", map);
        let marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 33, 13, "N"), toDecimal(28, 17, 23, "E")), "MIVNU", map);
        let marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 33, 3, "N"), toDecimal(28, 30, 52, "E")), "BAKOB", map);
        var marker4 = addMarker(new google.maps.LatLng(toDecimal(44, 27, 40, "N"), toDecimal(28, 30, 8, "E")), "FAF", map);
        var marker5 = addMarker(new google.maps.LatLng(toDecimal(44, 24, 12, "N"), toDecimal(28, 29, 39, "E")), "SDF", map);
        return [marker0, marker1, marker2, marker3, marker4, marker5];
    }
    PILAT() {
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 49, 26, "N"), toDecimal(28, 5, 52, "E")), "PILAT", map);
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 33, 13, "N"), toDecimal(28, 17, 23, "E")), "MIVNU", map);
        let marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 33, 3, "N"), toDecimal(28, 30, 52, "E")), "BAKOB", map);
        var marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 27, 40, "N"), toDecimal(28, 30, 8, "E")), "FAF", map);
        var marker4 = addMarker(new google.maps.LatLng(toDecimal(44, 24, 12, "N"), toDecimal(28, 29, 39, "E")), "SDF", map);
        return [marker0, marker1, marker2, marker3, marker4];
    ...
    CETUL() {
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 41, 51, "N"), toDecimal(28, 37, 37, "E")), "CETUL", map);
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 38, 14, "N"), toDecimal(28, 31, 34, "E")), "DINBA", map);
        let marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 33, 3, "N"), toDecimal(28, 30, 52, "E")), "BAKOB", map);
        var marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 27, 40, "N"), toDecimal(28, 30, 8, "E")), "FAF", map);
        var marker4 = addMarker(new google.maps.LatLng(toDecimal(44, 24, 12, "N"), toDecimal(28, 29, 39, "E")), "SDF", map);
        return [marker0, marker1, marker2, marker3, marker4];
    ...
    REVDA36() {
        ...
        var marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 3, 34, "N"), toDecimal(28, 45, 9, "E")), "BIRLU", map);
        var marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 4, 12, "N"), toDecimal(28, 26, 55, "E")), "PEVEX", map);
        let marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 14, 40, "N"), toDecimal(28, 28, 22, "E")), "FAF", map);
    ...
    DIRAL36() {
        ...
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 22, 59, "N"), toDecimal(28, 4, 59, "E")), "NAMUV", map);
        var marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 4, 12, "N"), toDecimal(28, 26, 55, "E")), "PEVEX", map);
        var marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 9, 42, "N"), toDecimal(28, 27, 40, "E")), "RUTOX", map);
        let marker4 = addMarker(new google.maps.LatLng(toDecimal(44, 14, 40, "N"), toDecimal(28, 28, 22, "E")), "FAF", map);
        return [marker0, marker1, marker2, marker3, marker4];
    }
    RIVOS36() {
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 39, 21, "N"), toDecimal(27, 39, 17, "E")), "RIVOS", map);
    ...
    CETUL36() {
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 41, 51, "N"), toDecimal(28, 37, 37, "E")), "CETUL", map);
        var marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 4, 12, "N"), toDecimal(28, 26, 55, "E")), "PEVEX", map);
        var marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 9, 42, "N"), toDecimal(28, 27, 40, "E")), "RUTOX", map);
        let marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 14, 40, "N"), toDecimal(28, 28, 22, "E")), "FAF", map);
        return [marker0, marker1, marker2, marker3];
    }
    //CONSTANTA TMA
    TMA() {
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 55, 30, "N"), toDecimal(27, 49, 21, "E")), "", map);
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 49, 26, "N"), toDecimal(28, 5, 52, "E")), "", map);
        let marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 25, 48, "N"), toDecimal(29, 26, 58, "E")), "", map);
        let marker3 = addMarker(new google.maps.LatLng(toDecimal(43, 43, 43, "N"), toDecimal(29, 26, 35, "E")), "", map);
        let marker4 = addMarker(new google.maps.LatLng(toDecimal(43, 44, 44, "N"), toDecimal(29, 2, 0, "E")), "", map);
        let marker5 = addMarker(new google.maps.LatLng(toDecimal(43, 40, 40, "N"), toDecimal(29, 0, 0, "E")), "", map);
        let marker6 = addMarker(new google.maps.LatLng(toDecimal(43, 45, 45, "N"), toDecimal(28, 36, 0, "E")), "", map);
    }
    RWY18() {
        // Approach RWY 18
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 27, 40, "N"), toDecimal(28, 30, 8, "E")), "FAF", map);
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 24, 12, "N"), toDecimal(28, 29, 39, "E")), "SDF", map);
        //RWY
        let marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 20, 47.20, "N"), toDecimal(28, 29, 10.73, "E")), "36", map);
        let marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 22, 40.04, "N"), toDecimal(28, 29, 26.13, "E")), "18", map);
        let icon = {
    ...
    RWY36() {
        // Approach RWY 36
        let marker0 = addMarker(new google.maps.LatLng(toDecimal(44, 14, 40, "N"), toDecimal(28, 28, 22, "E")), "FAF", map);
        let marker1 = addMarker(new google.maps.LatLng(toDecimal(44, 9, 42, "N"), toDecimal(28, 27, 40, "E")), "RUTOX", map);
        //RWY
        let marker2 = addMarker(new google.maps.LatLng(toDecimal(44, 20, 47.20, "N"), toDecimal(28, 29, 10.73, "E")), "36", map);
        let marker3 = addMarker(new google.maps.LatLng(toDecimal(44, 22, 40.04, "N"), toDecimal(28, 29, 26.13, "E")), "18", map);
        let icon = {
...
export function entryMarker() {
    var marker0 = addMarker2(new google.maps.LatLng(toDecimal(43, 44, 0, "N"), toDecimal(29, 6, 36, "E")), "REVDA", map);
    var marker1 = addMarker2(new google.maps.LatLng(toDecimal(44, 3, 59, "N"), toDecimal(29, 26, 36, "E")), "DENUB", map);
    let marker2 = addMarker2(new google.maps.LatLng(toDecimal(44, 28, 7, "N"), toDecimal(29, 18, 56, "E")), "NURPO", map);
    let marker3 = addMarker2(new google.maps.LatLng(toDecimal(44, 30, 39, "N"), toDecimal(27, 33, 15, "E")), "DIRAL", map);
    let marker4 = addMarker2(new google.maps.LatLng(toDecimal(44, 39, 21, "N"), toDecimal(27, 39, 17, "E")), "RIVOS", map);
    let marker5 = addMarker2(new google.maps.LatLng(toDecimal(44, 49, 26, "N"), toDecimal(28, 5, 52, "E")), "PILAT", map);
    let marker6 = addMarker2(new google.maps.LatLng(toDecimal(44, 41, 51, "N"), toDecimal(28, 37, 37, "E")), "CETUL", map);
    return [marker0, marker1, marker2, marker3, marker4, marker5, marker6];
}
export function vorNdb() {
    let VOR = addMarker(new google.maps.LatLng(toDecimal(44, 17, 8, "N"), toDecimal(28, 28, 42, "E")), "VOR/DME", map);
    let icon = {
